...
function Select(props) {
  ...
  const [value, setValue] = y$1((_k = select == null ? void 0 : select.current) == null ? void 0 : _k.value);
  ...
  function getSelectOptions(current) {
    if (!current)
      return [];
    const itemsOptions = current.querySelectorAll("option");
    if (!(itemsOptions == null ? void 0 : itemsOptions.length))
      return [];
  ...
  _(() => {
    ...
    const handler = (event) => {
      ...
      if (!event.isTrusted)
        return;
      const val = (_a2 = event == null ? void 0 : event.target) == null ? void 0 : _a2.value;
      const item = (_c2 = (_b2 = options2 == null ? void 0 : options2.find) == null ? void 0 : _b2.call(options2, ({ value: value2 }) => val == value2)) != null ? _c2 : null;
      setValue(item);
    };
  ...
  _(() => {
    ...
    if (initValue) {
      const init = (_a2 = opts == null ? void 0 : opts.find(({ value: value2 }) => value2 == initValue)) != null ? _a2 : null;
      setValue(init);
      emit("change", init);
    }
    emit("init", current);
  ...
  function setOptionsSelected(value2) {
    select.current.querySelectorAll("option").forEach((option) => {
      if (option.getAttribute("value") === value2) {
  ...
  _(() => {
    setOptionsSelected(value == null ? void 0 : value.value);
    emit("change", value);
  ...
  function handleChange(event) {
    setValue(event);
    select.current.value = event == null ? void 0 : event.value;
    const theEvent = new Event("change");
    select.current.dispatchEvent(theEvent);
  }
...
function createSelect(select, options2 = {}) {
  ...
  const cloneOrNot = replace2 ? select.cloneNode(true) : select;
  if (replace2) {
